...
<div class="bg-sidebar text-white w-64 min-h-screen flex flex-col">
    ...
    <div class="p-3 space-y-2 flex-1">
        ...
        <!-- MAIN NAVIGATION -->
        <h2 class="font-heading2 text-xs tracking-[0.2em] mb-2 px-2">
            MAIN NAVIGATION
        </h2>
    ...
    ADMINISTRATION
        ...
        <asp:LinkButton ID="lnkSignOut" runat="server"
            CssClass="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-red-600 transition-colors w-full mt-8"
