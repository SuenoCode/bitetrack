...
<div class="bg-sidebar text-white w-75 min-h-screen flex flex-col">
    ...
    <div class="p-3 space-y-2">
        <!-- MAIN NAVIGATION -->
        <h2 class="font-heading2 text-xs tracking-widest mb-2 px-2">MAIN NAVIGATION
        </h2>
    ...
    <span class="font-heading2 tracking-widest text-sm">Reports</span>
        ...
        <h2 runat="server" ID="adminHeader" class="font-heading2 text-xs tracking-widest mb-2 px-2 opacity-70" Visible="false">ADMINISTRATION
        </h2> 

        <asp:LinkButton ID="lnkUserManagement" runat="server" Visible="false"
            Style="display: flex; align-items: center; gap: 8px;"
            CssClass="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-blue-700 transition-colors w-full"
        ...
        <asp:LinkButton ID="lnkAudit" runat="server" Visible="false"
            Style="display: flex; align-items: center; gap: 8px;"
            CssClass="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-blue-700 transition-colors w-full"
        ...
        <asp:LinkButton ID="lnkSettings" runat="server" Visible="false"
            Style="display: flex; align-items: center; gap: 8px;"
            CssClass="flex items-center gap-3 px-4 py-2.5 rounded-lg hover:bg-blue-700 transition-colors w-full"
