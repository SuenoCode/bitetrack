...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function getColor(caseCount) {
                if (caseCount >= 30) {
                    return '#dc2626'; // Red - 30+ cases
                } else if (caseCount >= 20) {
                    return '#f97316'; // Orange - 20-29 cases
                } else if (caseCount >= 10) {
                    return '#ffce00'; // Light Orange/Yellow - 10-19 cases
                } else if (caseCount >= 1) {
                    return '#eab308'; // Yellow - 1-9 cases
                } else {
                    return '#22c55e'; // Green - No cases (0)
                }
            }
            ...
            function addLegend() {
                ...
                legend.onAdd = function () {
                    ...
                    div.innerHTML = `
            <h4 style="margin:0 0 10px 0; font-weight:bold; border-bottom:1px solid #ddd; padding-bottom:5px; color:#333;">
                Cases per Barangay
            </h4>
            <div style="display:flex; align-items:center; margin-bottom:8px;">
                <div style="width:20px; height:20px; background:#dc2626; margin-right:10px; border:1px solid #999;"></div>
                <span><b>30+ cases</b></span>
            </div>
            <div style="display:flex; align-items:center; margin-bottom:8px;">
                <div style="width:20px; height:20px; background:#f97316; margin-right:10px; border:1px solid #999;"></div>
                <span><b>20-29 cases</b></span>
            </div>
            <div style="display:flex; align-items:center; margin-bottom:8px;">
                <div style="width:20px; height:20px; background:#ffce00; margin-right:10px; border:1px solid #999;"></div>
                <span><b>10-19 cases</b></span>
            </div>
            <div style="display:flex; align-items:center; margin-bottom:8px;">
                <div style="width:20px; height:20px; background:#eab308; margin-right:10px; border:1px solid #999;"></div>
                <span><b>1-9 cases</b></span>
            </div>
            <div style="display:flex; align-items:center;">
                <div style="width:20px; height:20px; background:#22c55e; margin-right:10px; border:1px solid #999;"></div>
                <span><b>No cases</b></span>
            </div>
        `;
                    return div;
                };
    ...
    Status: ${caseCount >= 30 ? 'HIGH' :
                                caseCount >= 20 ? 'MEDIUM-HIGH' :
                                    caseCount >= 10 ? 'MEDIUM' :
                                        caseCount >= 1 ? 'LOW' : 'NO CASES'}
`);
