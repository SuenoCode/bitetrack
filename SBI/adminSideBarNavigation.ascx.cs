    ...
    public partial class adminSideBarNavigation : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                // Only Admin (A) can see User Management and the Admin header
                if (role != "A")
                {
        ...
        protected void btnPatientRegistration_Click(object sender, EventArgs e) => Response.Redirect("PatientRegistration.aspx");
        protected void btnCaseSurveillance_Click(object sender, EventArgs e) => Response.Redirect("CaseSurveillance.aspx");
        protected void btnVaccineManagement_Click(object sender, EventArgs e) => Response.Redirect("VaccineManagement.aspx");
        protected void btnReports_Click(object sender, EventArgs e) => Response.Redirect("Reports.aspx");
        protected void btnUserManagement_Click(object sender, EventArgs e) => Response.Redirect("UserManagement.aspx");
